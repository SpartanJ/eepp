...
enum class PropertyId : Uint32 {
	...
	Gap = String::hash( "gap" ),
	Editable = String::hash( "editable" ),
	SelectionType = String::hash( "selection-type" ),
	SelectionKind = String::hash( "selection-kind" ),
	IconSize = String::hash( "icon-size" ),
	SortIconSize = String::hash( "sort-icon-size" ),
	MainColumn = String::hash( "main-column" ),
	RowHeaderWidth = String::hash( "row-header-width" ),
	TableFlags = String::hash( "table-flags" ),
	IndentWidth = String::hash( "indent-width" ),
	ExpanderIconSize = String::hash( "expander-icon-size" ),
	TableModel = String::hash( "table-model" ),
