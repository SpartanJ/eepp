...
class EE_API Texture : public Image, public Drawable, private NonCopyable {
	public:
		...
		*/
		void drawFast( const Float& x, const Float& y, const Float& Angle = 0.0f, const Vector2f& scale = Vector2f::One, const Color& color = Color::White, const BlendMode &Blend = BlendAlpha, const Float &width = 0, const Float &height = 0 );
		...
		* @param texSector The texture sector to render. You can render only a part of the texture. ( default render all the texture )
		*/
		void drawQuad( const Quad2f& Q, const Vector2f& Offset = Vector2f(), const Float &Angle = 0.0f, const Vector2f &scale = Vector2f::One, const Color& color = Color::White, const BlendMode &Blend = BlendAlpha, const Rect& texSector = Rect(0,0,0,0) );
		...
		* @param texSector The texture sector to render. You can render only a part of the texture. ( default render all the texture )
		*/
		void drawQuadEx( Quad2f Q, const Vector2f& Offset = Vector2f(), const Float &Angle = 0.0f, const Vector2f &scale = Vector2f::One, const Color& Color0 = Color::White, const Color& Color1 = Color(255,255,255,255), const Color& Color2 = Color(255,255,255,255), const Color& Color3 = Color(255,255,255,255), const BlendMode &Blend = BlendAlpha, Rect texSector = Rect(0,0,0,0) );
