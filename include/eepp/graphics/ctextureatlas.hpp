...
class EE_API cTextureAtlas : public ResourceManager<cSubTexture> {
	public:
		...
		*	@param Name The texture name ( if any )
		*/
		cSubTexture * Add( const Uint32& TexId, const Recti& SrcRect, const std::string& Name = "" );
		...
		*	@param Name The texture name ( if any )
		*/
		cSubTexture * Add( const Uint32& TexId, const Recti& SrcRect, const Sizef& DestSize, const std::string& Name = "" );
		...
		*	@param Name The texture name ( if any )
		*/
		cSubTexture * Add( const Uint32& TexId, const Recti& SrcRect, const Sizef& DestSize, const Vector2i& Offset, const std::string& Name = "" );
