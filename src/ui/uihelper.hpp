...
enum UI_CONTROL_TYPES {
	...
	UI_TYPE_LISTBOX				= 13,
	UI_TYPE_LISTBOXITEM			= 14,
	UI_TYPE_DROPDOWNLIST		= 15,
	UI_TYPE_SEPARATOR			= 16,
	UI_TYPE_COMBOBOX			= 17,
	UI_TYPE_MENU				= 18,
	UI_TYPE_MENUITEM			= 19,
	UI_TYPE_MENUCHECKBOX		= 20,
	UI_TYPE_MENUSUBMENU			= 21,
	UI_TYPE_SPRITE				= 22,
	UI_TYPE_TEXTEDIT			= 23,
	UI_TYPE_TOOLTIP				= 24,
	UI_TYPE_GENERICGRID			= 25,
	UI_TYPE_WINDOW				= 26,
	UI_TYPE_WINMENU				= 27,
	UI_TYPE_SELECTBUTTON		= 28,
	UI_TYPE_POPUPMENU			= 29
};
