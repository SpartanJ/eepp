	...
	mResizeMap( ResizeMap )
{
	...
	mUIWindow->AddEventListener( cUIEvent::EventOnWindowClose, cb::Make1( this, &UIMapNew::WindowClose ) );
	...
	cUITextBox * Txt = mTheme->CreateTextBox( "Map Size", mUIWindow->Container(), Sizei(), Vector2i( 16, InitialY ), UI_CONTROL_DEFAULT_FLAGS | UI_DRAW_SHADOW | UI_AUTO_SIZE );
	...
	mUIRedSlider->AddEventListener( cUIEvent::EventOnValueChange, cb::Make1( this, &UIMapNew::OnRedChange ) );
	...
	mUIGreenSlider->AddEventListener( cUIEvent::EventOnValueChange, cb::Make1( this, &UIMapNew::OnGreenChange ) );
	...
	mUIBlueSlider->AddEventListener( cUIEvent::EventOnValueChange, cb::Make1( this, &UIMapNew::OnBlueChange ) );
	...
	OKButton->AddEventListener( cUIEvent::EventMouseClick, cb::Make1( this, &UIMapNew::OKClick ) );
	OKButton->Text( "OK" );
	...
	CancelButton->AddEventListener( cUIEvent::EventMouseClick, cb::Make1( this, &UIMapNew::CancelClick ) );
...
void UIMapNew::OnRedChange( const cUIEvent * Event ) {
...
void UIMapNew::OnGreenChange( const cUIEvent * Event ) {
	ColorA Col = mUIBaseColor->Background()->Color();
...
void UIMapNew::OnBlueChange( const cUIEvent * Event ) {
	ColorA Col = mUIBaseColor->Background()->Color();
...
void UIMapNew::OKClick( const cUIEvent * Event ) {
...
void UIMapNew::CancelClick( const cUIEvent * Event ) {
	mUIWindow->CloseWindow();
}

void UIMapNew::WindowClose( const cUIEvent * Event ) {
	eeDelete( this );
}
