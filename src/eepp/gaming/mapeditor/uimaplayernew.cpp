	...
	mLayer( NULL )
{
	...
	mUIWindow->AddEventListener( cUIEvent::EventOnWindowClose, cb::Make1( this, &UIMapLayerNew::WindowClose ) );
	...
	OKButton->AddEventListener( cUIEvent::EventMouseClick, cb::Make1( this, &UIMapLayerNew::OKClick ) );
	mUILayerName->AddEventListener( cUIEvent::EventOnPressEnter, cb::Make1( this, &UIMapLayerNew::OKClick ) );
	...
	CancelButton->AddEventListener( cUIEvent::EventMouseClick, cb::Make1( this, &UIMapLayerNew::CancelClick ) );
	CancelButton->Text( "Cancel" );

	mUIWindow->AddEventListener( cUIEvent::EventKeyUp, cb::Make1( this, &UIMapLayerNew::OnKeyUp ) );
...
void UIMapLayerNew::OnKeyUp( const cUIEvent * Event ) {
...
void UIMapLayerNew::OKClick( const cUIEvent * Event ) {
...
void UIMapLayerNew::CancelClick( const cUIEvent * Event ) {
	mUIWindow->CloseWindow();
}

void UIMapLayerNew::WindowClose( const cUIEvent * Event ) {
	eeDelete( this );
}
...
cUITextInput * UIMapLayerNew::UILayerName() const {
	return mUILayerName;
}
