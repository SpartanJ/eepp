...
void SyntaxDefinitionManager::addCSS() {
	add( { "CSS",
		   ...
		   {
			   { "true", "literal" },	   { "false", "literal" },		 { "white", "literal" },
			   { "black", "literal" },	   { "gray", "literal" },		 { "blue", "literal" },
			   { "red", "literal" },	   { "purple", "literal" },		 { "green", "literal" },
			   { "yellow", "literal" },	   { "transparent", "literal" }, { "none", "literal" },
			   { "center", "literal" },	   { "arrow", "literal" },		 { "hand", "literal" },
			   { "ibeam", "literal" },	   { "wait", "literal" },		 { "crosshair", "literal" },
			   { "waitarrow", "literal" }, { "sizenwse", "literal" },	 { "sizenesw", "literal" },
			   { "sizewe", "literal" },	   { "sizens", "literal" },		 { "sizeall", "literal" },
			   { "nocursor", "literal" },  { "important", "literal" },
		   } } )
