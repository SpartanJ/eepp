...
static void addGDScript() {
	SyntaxDefinitionManager::instance()->add( { "GDScript",
												{ "%.gd$" },
												{
													{ { "#.-\n" }, "comment" },
													{ { "\"", "\"", "\\" }, "string" },
...
static void addD() {
	SyntaxDefinitionManager::instance()->add( { "D",
												{ "%.d$", "%.di$" },
												{
													{ { "//.-\n" }, "comment" },
													{ { "/%*", "%*/" }, "comment" },
...
static void addHLSL() {
	SyntaxDefinitionManager::instance()->add( { "HLSL",
												{
													"%.hlsl$",
												},
												{
...
static void addOdin() {
	SyntaxDefinitionManager::instance()->add( { "Odin",
												{ "%.odin$" },
												{
													{ { "//.-\n" }, "comment" },
													{ { "/%*", "%*/" }, "comment" },
...
static void addR() {
	SyntaxDefinitionManager::instance()->add( { "R",
												{ "%.r$", "%.rds$", "%.rda$", "%.rdata$", "%.R$" },
												{
													{ { "#", "\n" }, "comment" },
													{ { "\"", "\"" }, "string" },
...
std::string SyntaxDefinitionManager::toCPP( const SyntaxDefinition& def ) {
	std::string buf = "\nstatic void add" + funcName( def.getLanguageName() ) + "() {";
	buf += "\nSyntaxDefinitionManager::instance()->add( {";
	// lang name
