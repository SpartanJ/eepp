	...
	add( { "PHP",
		...
		add( { "Go",
			   ...
			   },
			   {
				   ...
				   { "elseif", "keyword" },		 { "for", "keyword" },
				   { "continue", "keyword" },	 { "return", "keyword" },
				   { "struct", "keyword" },		 { "switch", "keyword" },
				   { "case", "keyword" },		 { "default", "keyword" },
				   { "const", "keyword" },		 { "package", "keyword" },
				   { "import", "keyword" },		 { "func", "keyword" },
				   { "var", "keyword" },		 { "type", "keyword" },
				   { "interface", "keyword" },	 { "select", "keyword" },
				   { "break", "keyword" },		 { "range", "keyword" },
				   { "chan", "keyword" },		 { "defer", "keyword" },
				   { "go", "keyword" },			 { "fallthrough", "keyword" },
				   { "int", "keyword2" },		 { "int64", "keyword2" },
				   { "int32", "keyword2" },		 { "int16", "keyword2" },
				   { "int8", "keyword2" },		 { "uint", "keyword2" },
				   { "uint64", "keyword2" },	 { "uint32", "keyword2" },
				   { "uint16", "keyword2" },	 { "uint8", "keyword2" },
				   { "uintptr", "keyword2" },	 { "float64", "keyword2" },
				   { "float32", "keyword2" },	 { "map", "keyword2" },
				   { "string", "keyword2" },	 { "rune", "keyword2" },
				   { "bool", "keyword2" },		 { "byte", "keyword2" },
				   { "error", "keyword2" },		 { "complex64", "keyword2" },
				   { "complex128", "keyword2" }, { "true", "literal" },
				   { "false", "literal" },		 { "nil", "literal" },
			   },
			   "//" } );
		...
		std::unordered_map<std::string, std::vector<std::string>> batchSymTable = {
			{ "keyword",
			  {
				  "if",			"else",			 "elsif", "not",  "for",	"do",
				  "in",			"equ",			 "neq",	  "lss",  "leq",	"gtr",
				  "geq",		"nul",			 "con",	  "prn",  "prn",	"lpt1",
				  "com1",		"com2",			 "com3",  "com4", "exist",	"defined",
