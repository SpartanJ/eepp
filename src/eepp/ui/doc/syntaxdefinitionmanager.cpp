...
SyntaxDefinitionManager::SyntaxDefinitionManager() {
	...
	add( {"Go",
		  ...
		  },
		  {
			  ...
			  {"defer", "keyword"},		 {"go", "keyword"},			 {"int", "keyword2"},
			  {"int64", "keyword2"},	 {"int32", "keyword2"},		 {"int16", "keyword2"},
			  {"int8", "keyword2"},		 {"uint", "keyword2"},		 {"uint64", "keyword2"},
			  {"uint32", "keyword2"},	 {"uint16", "keyword2"},	 {"uint8", "keyword2"},
			  {"uintptr", "keyword2"},	 {"float64", "keyword2"},	 {"float32", "keyword2"},
			  {"map", "keyword2"},		 {"string", "keyword2"},	 {"rune", "keyword2"},
			  {"bool", "keyword2"},		 {"byte", "keyword2"},		 {"error", "keyword2"},
			  {"complex64", "keyword2"}, {"complex128", "keyword2"}, {"true", "literal"},
			  {"false", "literal"},		 {"nil", "literal"},
		  },
		  "//"} );
	...
	add( {"Rust",
		  ...
		  },
		  {
			  ...
			  {"i8", "keyword2"},	  {"u16", "keyword2"},	 {"u32", "keyword2"},
			  {"u64", "keyword2"},	  {"usize", "keyword2"}, {"isize", "keyword2"},
			  {"f32", "keyword2"},	  {"f64", "keyword2"},	 {"f128", "keyword2"},
			  {"String", "keyword2"}, {"&str", "keyword2"},	 {"bool", "keyword2"},
			  {"true", "literal"},	  {"false", "literal"},	 {"None", "literal"},
			  {"Some", "literal"},	  {"Option", "literal"}, {"Result", "literal"},
		  },
		  "//"} );
...
const SyntaxDefinition& SyntaxDefinitionManager::find( const std::string& filePath,
	...
	const SyntaxDefinition& def = getStyleByExtension( filePath );
	if ( def.getLanguageName() == mStyles[0].getLanguageName() )
		return getStyleByHeader( header );
	return def;
}
