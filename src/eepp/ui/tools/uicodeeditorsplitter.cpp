...
UICodeEditorSplitter::getLocalDefaultKeybindings() {
	return {
		{ { KEY_S, KEYMOD_DEFAULT_MODIFIER }, "save-doc" },
		{ { KEY_L, KEYMOD_DEFAULT_MODIFIER | KEYMOD_SHIFT }, "lock-toggle" },
		{ { KEY_T, KEYMOD_DEFAULT_MODIFIER }, "create-new" },
		{ { KEY_W, KEYMOD_DEFAULT_MODIFIER }, "close-doc" },
		{ { KEY_TAB, KEYMOD_DEFAULT_MODIFIER }, "next-doc" },
		{ { KEY_TAB, KEYMOD_DEFAULT_MODIFIER | KEYMOD_SHIFT }, "previous-doc" },
		...
		{ { KEY_J, KEYMOD_DEFAULT_MODIFIER | KEYMOD_LALT }, "switch-to-previous-split" },
		{ { KEY_L, KEYMOD_DEFAULT_MODIFIER | KEYMOD_LALT }, "switch-to-next-split" },
		{ { KEY_N, KEYMOD_DEFAULT_MODIFIER | KEYMOD_LALT }, "switch-to-previous-colorscheme" },
		{ { KEY_M, KEYMOD_DEFAULT_MODIFIER | KEYMOD_LALT }, "switch-to-next-colorscheme" },
		{ { KEY_1, KEYMOD_DEFAULT_MODIFIER }, "switch-to-tab-1" },
		{ { KEY_2, KEYMOD_DEFAULT_MODIFIER }, "switch-to-tab-2" },
		{ { KEY_3, KEYMOD_DEFAULT_MODIFIER }, "switch-to-tab-3" },
		{ { KEY_4, KEYMOD_DEFAULT_MODIFIER }, "switch-to-tab-4" },
		{ { KEY_5, KEYMOD_DEFAULT_MODIFIER }, "switch-to-tab-5" },
		{ { KEY_6, KEYMOD_DEFAULT_MODIFIER }, "switch-to-tab-6" },
		{ { KEY_7, KEYMOD_DEFAULT_MODIFIER }, "switch-to-tab-7" },
		{ { KEY_8, KEYMOD_DEFAULT_MODIFIER }, "switch-to-tab-8" },
		{ { KEY_9, KEYMOD_DEFAULT_MODIFIER }, "switch-to-tab-9" },
		{ { KEY_0, KEYMOD_DEFAULT_MODIFIER }, "switch-to-last-tab" },
