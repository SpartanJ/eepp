	...
	if ( widget->getLayoutPositionRule() != LayoutPositionRule::None && widget->getParent() == widget->getLayoutPositionRuleWidget()->getParent() ) {
		...
		switch ( Font::getHorizontalAlign( widget->getLayoutGravity() ) ) {
			...
			case UI_HALIGN_RIGHT:
				pos.x = getSize().getWidth() - widget->getSize().getWidth() - widget->getLayoutMargin().Right - mPadding.Right;
				break;
			case UI_HALIGN_LEFT:
			default:
		...
		switch ( Font::getVerticalAlign( widget->getLayoutGravity() ) ) {
			...
			case UI_VALIGN_BOTTOM:
				pos.y = getSize().getHeight() - widget->getSize().getHeight() - widget->getLayoutMargin().Bottom - mPadding.Bottom;
				break;
			case UI_VALIGN_TOP:
			default:
