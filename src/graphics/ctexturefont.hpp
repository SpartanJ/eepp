...
class EE_API cTextureFont : public cFont {
	public:
		...
		* @return True success
		*/
		bool LoadFromPack( cPack* Pack, const std::string& FilePackPath, const Uint32& TexId, const bool& VerticalDraw = false );
		...
		* @return True if success
		*/
		bool LoadFromMemory( const Uint32& TexId, const Uint8* CoordData, const eeUint& CoordDataSize, const bool& VerticalDraw = false );
	private:
		cTextureFactory* TF;
